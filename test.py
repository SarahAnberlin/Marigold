...
with torch.no_grad():
    ...
    rgb_noise_scheduler = DDPMScheduler.from_pretrained('stable-diffusion-2', device=device)
    ...
    for t in timesteps:
        ...
        save_image(depth, f"{save_root}/depth_{t}.png")
        save_image(rgb, f"{save_root}/rgb_{t}.png")
